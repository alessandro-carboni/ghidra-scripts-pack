...
func SelectOutputField(raw map[string]any, field string) (any, []string, error) {
	fieldMap := map[string]string{
		...
		"rust_score_calibration":  "rust_enrichment.score_calibration",
		"rust_decision_summary":   "rust_enrichment.decision_summary",
		"rust_malware_risk":       "rust_enrichment.malware_risk",
		"rust_packing_risk":       "rust_enrichment.packing_risk",
		"rust_risk_split_summary": "rust_enrichment.risk_split_summary",
		"rust_score_drivers":      "rust_enrichment.score_drivers",
	}
